import { StyleSheet, Text, TextInput, Pressable, View, FlatList, Modal, Button } from 'react-native'
    ...
    return (
        <React.Fragment>
           ...
           { createdClassrooms.length != 0 ? <FlatList
                ...
                renderItem={({item}) => (
                    <Classroom id={item.classroomId} name={item.classroomName} createdAt={item.createdAt} createdBy={item.createdBy} onPress={setSelectedClassroomId}/>
                )}
            /> : null }
            { createModalVisible ?  
